...
class UserRecipeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $recipe->save();
        return redirect('/userrecipe')->with('success', "Recipe $recipe->food_name has been added");
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $recipe->update();
        return redirect('/userrecipe')->with('success', "chef $recipe->food_name has been updated");
    }
    ...
    public function destroy(Recipe $recipe)
    {
        //
        $recipe->delete();
        return redirect('/userrecipe')->with('success', "$recipe->food_name has been removed");;
    }
